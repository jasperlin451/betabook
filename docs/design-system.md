...
Sends and Journal share `DateFilter`, labeled Dates. The options are Any (default),
...
Any clears the constraint. Selecting dates in Journal replaces its year filter.
