...
test("compact charts share a row and the calendar fits without scrolling", async ({
  page,
}, info) => {
...
test("a decade of volume fits with readable labels and immediate hover details", async ({
  page,
}, info) => {
