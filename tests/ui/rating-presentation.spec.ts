...
test("rating range label and stars share a vertical center on desktop", async ({ page }, info) => {
...
test("display ratings place the number before the star", async ({ page }, info) => {
