...
type AreaReparentDialogProps = {
  ...
  /** Called after the area actually moves (admin path only) — the caller
   * typically navigates to the area's new parent. */
  onDone?: (newParentId: number) => void;
};
 ...
 * friendly message rather than filtered out of the picker. */
export function AreaReparentDialog({ areaId, state, onDone }: AreaReparentDialogProps) {
