 ...
 * disabled states) — so a native date picker or select is indistinguishable
 * from the styled field beside it. A hand-rolled approximation used to give
 * these a hairline border and a smaller radius that HeroUI fields never had. */
