 ...
 * closing as if the climb had already moved. The admin path needs no
 * navigation callback — applyClimbMove's refresh() re-renders the page in
 * place. */
export function ClimbMoveDialog({ climbId, state }: ClimbMoveDialogProps) {
